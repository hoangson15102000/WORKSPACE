...
while True:
    ...
    elif "turn on the light one" in you:
        robot_brain = "turned on the light one"
        print("robot:" + robot_brain)
        client.publish("S1","1")
    elif "turn off the light one" in you:
        robot_brain = "turned off the light one"
        print("robot:" + robot_brain)
        client.publish("S1","0")
    elif you == "turn on the light two":
        robot_brain = "turned on the light two"
        print("robot:" + robot_brain)
        client.publish("S2","1")
    elif you == "turn off the light two":
        robot_brain = "turned on the light two"
        print("robot:" + robot_brain)
        client.publish("S2","0")
    elif you == "turn on the light three":
        robot_brain = "turned on the light three"
        print("robot:" + robot_brain)
        client.publish("S3","1")
    elif you == "turn off the light three":
        robot_brain = "turned off the light three"
        print("robot:" + robot_brain)
        client.publish("S3","0")
