...
if (text=="Xin chào"):
    texttospeech("Chúc ông bà có một ngày tốt lành. Tôi là trợ lý ảo Saitama. Rất hân hạnh được phục vụ mọi người. Hãy nói bật đèn số mấy hoặc tắt đèn số mấy để điều khiển đèn. Xin cám ơn.")
    ...
    texttospeech("xin lỗi tôi chưa hiểu bạn đang nói gì, bạn nói lại cho mình hiểu nhé")
